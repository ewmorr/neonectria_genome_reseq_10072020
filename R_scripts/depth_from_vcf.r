...
#filtered VCF
vcf <- read.vcfR("~/Nd_SPANDx_all_seqs/Outputs/Master_vcf/out.filtered.PASS.vcf", verbose = FALSE)
...
#unfiltered VCF
vcf <- read.vcfR("~/Nd_SPANDx_all_seqs/Outputs/Master_vcf/out.vcf", verbose = FALSE)
dp <- extract.gt(vcf, element='DP', as.numeric=TRUE)
