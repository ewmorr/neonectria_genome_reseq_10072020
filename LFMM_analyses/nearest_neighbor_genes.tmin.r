...
lfmm_results.sig$distance %>% abs %>% mean #6235.6
lfmm_results.sig$distance %>% abs %>% median #2362
lfmm_results.sig %>% filter(distance > 0 | distance < 0) %>% pull(distance) %>% abs %>% range #2349 to 20412
